              ...
              <div className="flex flex-col sm:flex-row flex-wrap gap-4 md:gap-6 min-[1300px]:gap-8 lg:gap-8 w-full items-stretch">
                {cards.map((card, index) => (
                  <div
                    ...
                    style={{
                      borderRadius: "14px",
                      border: "0.667px solid rgba(231, 229, 228, 0.50)",
                      background: "#FFF",
              ...
              >
                ...
                <div
                  ...
                  style={{
                    ...
                    height: "81.15%",
                    aspectRatio: "1/1",
                    backgroundImage: "url(/assets/images/mon-adams-back.png)",
                ...
                <div
                  ...
                  style={{
                    aspectRatio: "1/1",
                    backgroundImage: "url(/assets/images/mon-adams.png)",
                    backgroundSize: "cover",
                    backgroundPosition: "50%",
                    backgroundRepeat: "no-repeat",
                    zIndex: 3,
